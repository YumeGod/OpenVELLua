...
local function on_aim_fire(e)
    if ui_get(aimbotlog_enable) and ui_get(on_fire_enable) and e ~= nil then
        ...
        "[Get good,Get gamesense] yeeted ", string.lower(target_name),
        ", hb: ", group,
        "  dmg: ", e.damage,
...
local function on_player_hurt(e)
    ...
    local message = "[Get good,Get gamesense] hit " .. string.lower(target_name) .. ", hb: " .. group .. "  dmg: " .. e.dmg_health .. "  rhp: " .. rem_health
    if rem_health <= 0 then
...
local function on_aim_miss(e)
    ...
    if e.reason == "?" then
        ...
        client_color_log(r, g, b,
        "[Get good,Get gamesense] missed ", string.lower(target_name),
        ", hb: ", group,
        "  r: ", reason)
    end
end
