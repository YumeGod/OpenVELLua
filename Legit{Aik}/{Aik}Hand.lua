...
local weapon_chams = setmetatable({
    ...
    cham = ui_new_checkbox("LUA", "B", "Weapon chams"),
    color = ui_new_color_picker("LUA", "B", "Weapon color", 255, 255, 255, 255),
    texture = ui_new_combobox("LUA", "B", "Weapon materials", getMenuItems(textures)),
    flags = ui_new_multiselect("LUA", "B", "Weapon flags", getMenuItems(material_var_flags)),
